...
describe("Testing Profile Objects", async () => {
    test("Create Profile Objects", () => {
        ...
        let profile3 = new profile.Profile([mod_fabricAPI_modrinth, mod_sodium_curseforge, mod_worldedit_curseforge], [])
        let profile4 = new profile.Profile(
            [mod_boingBoing_curseforge, mod_invalid, mod_fabricAPI_modrinth],
            [new mod.Priority("Awesome Priority"), new mod.Priority("Awesome Priority", 100, 100, 100)]
        )
    })
