# --------------------------------------------------
# 
# appData.py is home of the DataManager class, which was the primary supporting
# object for PyServer.
# 
# PyServer was the backend server that allowed Mod Tracker Web b5.0 to access
# the pre-existing python code. In b6.0, Mod Tracker Web was given its own
# backend written in JS, eliminating the need for PyServer.
# 
# This file is now deprecated.
#
# --------------------------------------------------

import sys, os, mod, loadFromJson
